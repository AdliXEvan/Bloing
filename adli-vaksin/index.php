                    ...
                    <div class="col">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="editpasien.php?edit=<?= $row['idPasien']; ?>" class="btn btn-warning btn-sm">Edit</a> <a href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('apakah anda ingin menghapus ini')">Hapus</a></td>
                            </tr>
                        <?php } ?>
                        </table>
                    </div>
